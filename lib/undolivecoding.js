...
export default {
  ...
  changeText () {
    ...
    if(containers[patternNum]["used"] === false){
      ...
      // NOT NEEDED in this version, will change line directly instead
  ...
  createBox (lineNum, patternNum, isGraph) {
    ...
    let lastLine = paragraphRange.end.row;
    console.log("row " + paragraphRange);
    console.log("linenum " + lineNum);
    // I don't totally understand why these values work for the range...
    let range = new Range([lastLine+1, 0], [lastLine+1, 0]);
