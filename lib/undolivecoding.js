...
export default {
  ...
  refreshGraph (container, patternNum) {
    ...
    res = res.map((x, idx) => {
      ...
      return {name: name, parentID: parent, idx: idx+1, isSelected: fill, patternNum: patternNum, bgColor: background_color};
    });
    ...
    res.push({name: '0', idx: 0, isSelected: fill, patternNum: patternNum, bgColor: background_color});
