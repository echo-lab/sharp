    ...
    if (numBoots === 0) {
      ...
      editor.onDidChange(() => {
        ...
        if (lastSavedText === currentText){ // Text matches
          ...
          if(this.history.getPatternHistories()[patternIndex].statesMatch == false) {
            // remove the dotted temporary node
          ...
          if(this.history.getPatternHistories()[patternIndex].statesMatch == true) {
