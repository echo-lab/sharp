...
export default {
  ...
  activate(state) {
    ...
    atom.contextMenu.add({
      'atom-text-editor': [{
        label: 'Tag Node',
        submenu: [
          {label: 'Red', command:'sharp:tagRed'},
          {label: 'Green', command:'sharp:tagGreen'},
          {label: 'Blue', command:'sharp:tagBlue'},
          {label: 'Purple', command:'sharp:tagPurple'},
          {label: 'Orange', command:'sharp:tagOrange'}
        ],
        shouldDisplay: (event) => {
  ...
  toggle() {
    ...
    if (numBoots === 0) {
      ...
      // Register command that toggles this view
      atom.commands.add('atom-workspace', 'sharp:enter', () => {
        this.addWorldState()
      });
      ...
      atom.commands.add('atom-workspace', 'sharp:enterAll', () => {
        this.runAll()
      });

      // color fill commands
      atom.commands.add('atom-workspace', 'sharp:tagRed', () => {
        this.tagNode('#900')
      });
      atom.commands.add('atom-workspace', 'sharp:tagGreen', () => {
        this.tagNode('#090')
      });
      atom.commands.add('atom-workspace', 'sharp:tagBlue', () => {
        this.tagNode('#06f')
      });
      atom.commands.add('atom-workspace', 'sharp:tagPurple', () => {
        this.tagNode('#85e')
      });
      atom.commands.add('atom-workspace', 'sharp:tagOrange', () => {
        this.tagNode('#d80')
      });
